export const contenido = {
    ...
    firstParagraph : "Las Tecnologías de la Información y la Comunicación (TIC) son un conjunto de herramientas y recursos que permiten procesar, administrar y distribuir información a través de medios tecnológicos como computadoras, teléfonos, televisores y más.\n" +
        "\n" +
